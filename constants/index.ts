...
export function getBlockURL(block: string | null | undefined): string {
  return `https://etherscan.io/block/${block}`;
}

export function getAddressURL(address: string | null | undefined): string {
