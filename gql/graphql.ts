...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    FeedQuery(variables?: FeedQueryQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<FeedQueryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FeedQueryQuery>(FeedQueryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'FeedQuery', 'query');
    }
  };
}
