...
export type CreateCommentMutation = {
  __typename?: "Mutation";
  addComment?: { __typename?: "CommentResponse"; status: number } | null;
};
...
export function getSdk(
  ...
  return {
    CreateComment(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<CreateCommentMutation>(
            CreateCommentDocumentString,
            variables,
    ...
    FeedQuery(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<FeedQueryQuery>(
            FeedQueryDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "FeedQuery",
